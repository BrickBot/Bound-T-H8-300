...
-- Version information added by Tidorum Ltd:
-- $Revision: 1.4 $
-- $Date: 2007-04-18 18:29:57 $
-- $Name:  $
--
-- $Log: table_of_strings_and_static_values_g.ads,v $
-- Revision 1.4  2007-04-18 18:29:57  niklas
-- BT-CH-0057.
--
-- Revision 1.3  2007/03/29 12:43:58  niklas
-- BT-CH-0056.
--
-- Revision 1.2  2004/05/02 07:04:43  niklas
-- Changed Character_Type to "private" instead of "(<>)", because this module
-- is applied in Bound-T with Character_Type bound to an access type, and on
-- some Bound-T platforms (e.g GNAT/Win-NT 3.12) access types are not discrete.
--
...
private
  type Access_String_Type is access String_Type;
   ...
   --:dbpool Access_String_Pool : GNAT.Debug_Pools.Debug_Pool;

   --:dbpool for Access_String_Type'Storage_Pool use Access_String_Pool;
