--  $Source: /home/fs/boundt/cvs/boundt/platform/win32ada/win32-vfw.ads,v $
...
private
   ...
   --  vfw.h:2014
   pragma Import (Stdcall, CLSID_AVISimpleUnMarshal,
   ...
   --  vfw.h:2339
   pragma Import (Stdcall, AVIMakeStreamFromClipboard,
   ...
   --  vfw.h:3390
   pragma Import (Stdcall, capGetDriverDescriptionA,
                    "capGetDriverDescriptionA");
   --  vfw.h:3396
   pragma Import (Stdcall, capCreateCaptureWindowW, "capCreateCaptureWindowW");
   --  vfw.h:3400
   pragma Import (Stdcall, capGetDriverDescriptionW,
