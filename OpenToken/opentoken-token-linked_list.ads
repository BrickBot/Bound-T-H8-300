...
--
-- Update History:
-- $Log: opentoken-token-linked_list.ads,v $
-- Revision 1.1.1.1  2000-08-12 14:20:24  niklas
...
private
   ...
   type Instance is new Ada.Finalization.Controlled with record
    ...
    -- list nodes.
    ----------------------------------------------------------------------------
    procedure Adjust (List : in out Instance);
    procedure Finalize (List : in out Instance);
