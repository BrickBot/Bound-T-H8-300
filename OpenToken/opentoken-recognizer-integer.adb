...
-- Revision 1.2  2009-07-03 21:58:02  niklas
-- Corrected Analyze to set Verdict := So_Far_So_Good for '+' and '-'
-- when The_Token.Allow_Signs is true. Before, the Verdict was left
-- undefined, which could prevent the recognition of signed integers.
--
-- Revision 1.1.1.1  2000-08-12 23:57:18  niklas
