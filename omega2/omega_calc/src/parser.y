...
#define CALC_VERSION_STRING "Omega Calculator v2.1+Tidorum"
...
int main(int argc, char **argv){
  ...
  setbuf (stdout, NULL);
  // Disables buffering of the output, for use with Bound-T.
  // Bound-T uses Omega Calculator via pipes, and assumes
  // line-by-line feedback from commands to results.

  printf("# %s (based on %s, %s, coef "
#if defined WIN32
       "%Iu"
#else
       "%zi"
