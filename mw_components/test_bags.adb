-- Filename        : test_bags.adb
-- Description     :
-- Author          : Mats Weber
-- Created On      : long ago
-- Last Modified By: Mats Weber
-- Last Modified On: Fri Jul  3 18:40:14 1998
-- Update Count    : 26


with Bags.Access_By_Item,
     Bags.Bounded_Operations,
     Bags.Set_Operations,
     Text_IO,
     Integer_Text_IO,
     User_Interface,
...
-------------------
   ...
   package Rec_Bags is new Bags(Key_Type  => Integer,
                                Item_Type => Rec,
                                Key_Of    => Key_Of,
                                Count     => Integer);
   ...
   begin
      Put_Subtree(To_Binary_Tree(T).Root, Level => 1);
   end Put_Structure;
   ...
   begin
      Check_Balance(To_Binary_Tree(T).Root, Max_Depth => Maximum_Depth);
   exception
      when Balance_Error =>
